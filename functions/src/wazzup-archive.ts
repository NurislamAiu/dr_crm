// ============================================================================
// АРХИВ WhatsApp/Wazzup-функций (сняты с деплоя 2026-08-05 при переходе на
// Telegram). Файл НЕ импортируется из index.ts и потому не деплоится.
// Вернуть какую-то функцию = перенести/реэкспортировать её в index.ts.
// ============================================================================
